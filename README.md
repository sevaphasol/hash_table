...
Полное время выполнения ***crc32_hash*** уменьшилось в
```math
\frac{256\,282\,459}{125\,365\,341} \approx 2.04 \,раза
```
...
Полное время выполнения ***hash_table_find*** уменьшилось в
```math
\frac{825\,069\,300}{697\,271\,000} \approx 1.18 \,раза
```
...
Полное время выполнения ***compare_keys*** уменьшилось в
```math
\frac{411\,960\,907}{67\,188\,675} \approx 6.13 \,раза
```

Полное время выполнения ***crc32_hash*** уменьшилось в
```math
\frac{125\,365\,341}{19\,431\,188} \approx 6.45 \,раза
```
...
Полное время выполнения ***hash_table_find*** уменьшилось в
```math
\frac{697\,271\,000}{310\,734\,700} \approx 2.24 раза
```
...
Полное время выполнения ***list_find*** уменьшилось в
```math
\frac{220\,037\,500}{163\,141\,300} \approx 1.35 раза
```
...
Полное время выполнения ***hash_table_find*** уменьшилось в
```math
\frac{310\,734\,700}{240\,096\,500} \approx 1.29 раза
```
...
Полное время выполнения ***hash_table_find*** уменьшилось в
```math
\frac{742\,551\,500}{240\,096\,500} \approx 3.09 раза.
```
