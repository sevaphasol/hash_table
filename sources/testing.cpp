...
int main()
{
    ...
    hash_table_ctor(&hash_table, HashTableSize, murmurhash3);
    ...
    if (get_data_for_hash_func(&hash_table)) {
        fprintf(stderr, "get_data_for_hash_func error\n");
    }
